...
exports.deleteUpdate = exports.updateUpdate = exports.createUpdate = exports.getUpdates = exports.getOneUpdates = void 0;
var db_1 = __importDefault(require("../db"));
var getOneUpdates = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var update;
...
exports.getOneUpdates = getOneUpdates;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                updates = products.reduce(function (allUpdates, product) {
                    return __spreadArray(__spreadArray([], allUpdates, true), product.update, true);
                }, []);
                res.json({ data: updates });
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                product = _a.sent();
                if (!product) {
                    return [2 /*return*/, res.json({ message: 'Product Not Found' })];
                }
...
var updateUpdate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, updates, match, update;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1["default"].product.findMany({
                    where: {
